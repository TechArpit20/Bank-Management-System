...
<h1> <%= (String)session.getAttribute("error_name") %> </h1>
<h2> <%= (String)session.getAttribute("error_tagline") %> </h2>
</div>
<br>
<br>
<% out.println("<a href=");  %>
<%= session.getAttribute("redirect") %>
<% out.println(">Go Back</a></h3>"); %>
</div>
</div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"661591895cf952c7","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.5.2","si":10}'></script>
</body>
</html>
